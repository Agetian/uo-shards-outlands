...
namespace Server.Engines.XmlSpawner2
{
	public class XmlQuestPointsRewards
	{
		...
		public static void Initialize()
		{
            ...
            PointsRewardList.Add( new XmlQuestPointsRewards( 1000, typeof(SkillMasteryScroll), "105 Smithing powerscroll", 1000, 0x14F0, 0, 5, new object[] { SkillName.Blacksmith, 105 }));
            PointsRewardList.Add( new XmlQuestPointsRewards( 2000, typeof(SkillMasteryScroll), "110 Smithing powerscroll", 2000, 0x14F0, 0x22, 5, new object[] { SkillName.Blacksmith, 110 }));
            PointsRewardList.Add( new XmlQuestPointsRewards( 4000, typeof(SkillMasteryScroll), "115 Smithing powerscroll", 4000, 0x14F0, 0x44, 5, new object[] { SkillName.Blacksmith, 115 }));
